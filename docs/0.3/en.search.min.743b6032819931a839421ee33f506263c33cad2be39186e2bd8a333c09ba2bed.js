...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.46b31c64a522f899402a1d743e3046049ce0d57f7253a363186cd0021430152e.js',function(){input.required=false;search();});}
