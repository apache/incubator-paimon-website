...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/0.4/flexsearch.min.js');loadScript('/docs/0.4/en.search-data.min.c9138fb970d2b1350d16524d23883a53c18872c82fea22902d2d920a21f75bf5.js',function(){input.required=false;search();});}
