...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.db4fac240012db3241bb8bffbf9a636b074584e9a6cd1a1b61d2a9b548b93649.js',function(){input.required=false;search();});}
