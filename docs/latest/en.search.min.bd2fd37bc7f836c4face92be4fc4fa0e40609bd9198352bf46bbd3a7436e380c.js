...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flink/flink-table-store-docs-release-0.3/flexsearch.min.js');loadScript('/flink/flink-table-store-docs-release-0.3/en.search-data.min.13c5b9b29eebf890fd00bdf192d97b95c5fe940b8083e4fb7ad253c4a26bccfd.js',function(){input.required=false;search();});}
