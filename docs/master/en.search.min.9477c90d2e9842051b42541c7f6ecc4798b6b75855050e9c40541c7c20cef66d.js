...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.daacc7d1e91af8542b27455ab9e0dac1e4cf847463fe40ad3fb774211f456459.js',function(){input.required=false;search();});}
