...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/docs/master/flexsearch.min.js');loadScript('/docs/master/en.search-data.min.47f95e54cbacadfe274f911e8b56585c767c32e23f48fa0f182999fa7e77cb60.js',function(){input.required=false;search();});}
